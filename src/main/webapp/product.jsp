...
<html>
    ...
    <body>
        ...
        <div class="container"> 
            ...
            out.print(""
                + "<img src='images/" + product.getImageLocation() + "'>"
                + "<div class='container>"
                + "<span class='border'><div class='container'><h1>" + product.getName() + "</h1></div>"
                + "<div class='container'><h3>" + product.getDesc() + "</h3</div>"
                ...
                + "</span>"
                + "<span class='border'><form action='AddToCartFromProduct'><input type='hidden' value='" + product.getID() + "' name='product'"
            ...
            out.print("</select></div>"
                + "<div class='container'><button type='submit' class='btn btn-dark'>Add to Cart</button>"
                + "</div></form>"
                + "</div>");
            %>
        </div>
